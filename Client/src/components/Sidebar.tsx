    ...
    return (
        <>
            <div className="sm:block hidden">
                <div className="dark:text-white text-black dark:bg-gray-950 lg:w-56 md:w-44 w-16 sm:p-3 p-2 border-slate-600 border-r h-screen flex flex-col justify-between">
